...
def repo_create_workshop(db: Session, tenant_id: UUID | str, user_id: int, workshop_data: dict) -> Workshop:
    workshop = Workshop(
        tenant_id=tenant_id,
        user_id=user_id,
...
def repo_get_workshop_by_id(db: Session, workshop_id: int, tenant_id: UUID | str) -> Workshop | None:
...
def repo_get_workshop_all_clients(db: Session, workshop_id: int, tenant_id: UUID | str) -> List[User]:
    """
